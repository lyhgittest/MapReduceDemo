...
public class SearchIndexDriverA {

	public static void main(String[] args) throws Exception {
		args = new String[] { "D:\\dp\\test\\mapreduce\\searchIndexOutput", "D:\\dp\\test\\mapreduce\\searchIndexOutputA" };
		Configuration conf = new Configuration();
		Job job = Job.getInstance(conf);

		job.setJarByClass(ETLDriver.class);
		job.setMapperClass(SearchIndexMapperA.class);
		job.setReducerClass(SearchIndexReducerA.class);
